"""
Test file cho thuat toan Pure Forward Chaining.
...
def run_test(test_id):
    """Chay thuat toan Pure Forward Chaining cho mot bo test cu the."""
    ...
    print(f"\n{'='*60}")
    print(f"  Test {test_id:02d} - Thuat toan Pure Forward Chaining")
    print(f"{'='*60}")
    ...
    # 3. Chay thuat toan Pure Forward Chaining
    solver = PureForwardChainingSolver(rules)
    print("\n  Dang giai bang Pure Forward Chaining...")
...
def main():
    print("=" * 60)
    print("  FUTOSHIKI SOLVER - TEST PURE FORWARD CHAINING")
    print("=" * 60)
    ...
    # Tong ket
    print(f"\n{'='*60}")
    print("  TONG KET - PURE FORWARD CHAINING")
    print(f"{'='*60}")
