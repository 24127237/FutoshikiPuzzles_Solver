"""
Test file cho thuat toan Backtracking.
...
def run_test(test_id):
    """Chay thuat toan Backtracking cho mot bo test cu the."""
    ...
    print(f"\n{'='*60}")
    print(f"  Test {test_id:02d} - Thuat toan Backtracking")
    print(f"{'='*60}")
